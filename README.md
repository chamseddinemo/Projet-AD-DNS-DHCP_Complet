...
REV-Projet est un environnement de laboratoire Windows Server conçu pour des opérations IT d'une entreprise de Tech. Ce projet démontre l'implémentation et la gestion des services Windows Server.
